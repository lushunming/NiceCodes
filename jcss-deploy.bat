...
::项目名
set projectName=hw-cloud-jcss-jenkins
::项目下的web包名
set webProjectName=hw-cloud-jcss-web
::hw-web名称
set hwWeb=hw-web
::项目svn目录
set svnURL= https://192.168.1.223:8443/svn/vtx-cloud/trunk/hw-cloud-jcss-jenkins
::用来替换的cloud.properties 路径
set cloudPropertyURL=F:\work\utils\management\management\cloud.properties
::用来替换的custom.properties 路径
set customPropertyURL=F:\work\utils\management\management\custom.properties
::tomcat 路径后面带\
